...
/**
 * Class which implements the Julia Set.
 *
 * @author Josh Labonte
...
public class Julia extends Fractal{
	...
	private final static double X_LOWER_LIM = -1.7;
	
	/** Upper limit to find X coordinate. */
	private final static double X_UPPER_LIM = 1.7;
	
	/** Lower limit to find Y coordinate. */
	private final static double Y_LOWER_LIM = -1.0;
	
	/** Upper limit to find Y coordinate. */
	private final static double Y_UPPER_LIM = 1.0;
	
	/** 2-D array of type int. */
	private int[][] _juliEscape;

	/** This mandel method assigns a 2-D array of type int to an array of the escape times in the fractal superclass */
	public Julia() {
	...
	{
		double xPrime = (xCalc * xCalc) - (yCalc * yCalc) + -0.72689;
